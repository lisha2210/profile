                ...
                <div className="border-x border-primary/10">
                    ...
                    <div className="border-t border-primary/10">
                        <div className="flex flex-col max-w-3xl mx-auto px-4 sm:px-7 py-9 md:py-16 ">
                            {certificationsData?.map((value: any, index: any) => {
                                return (
                                    <div
                                        key={index}
                                        ...
                                        <div className="flex flex-wrap gap-5 items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-2.5 border border-primary/10 rounded-lg py-1.5 px-3">
                                                <div className={`w-4 h-2 rounded-sm bg-primary/20`} />
                                                <p className="text-sm xs:text-base text-primary">{value?.startYear} · {value?.location}</p>
                                            </div>
                                        </div>
                                        <ul>
